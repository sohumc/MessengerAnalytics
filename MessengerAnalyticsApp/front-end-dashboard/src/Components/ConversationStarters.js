...
export default function ConversationStarters() {
    ...
    useEffect(() => {
        ...
        data => {
            setConversationStartersData(data["conversation_starters"])
            });
        }, [conversation_id]);
    ...
    var sortable = [];
    for (var mentionedEntry in conversationStartersData) {
        sortable.push([mentionedEntry, conversationStartersData[mentionedEntry]]);
    }
      ...
      <Table  aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="right">Times Thirsty</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
